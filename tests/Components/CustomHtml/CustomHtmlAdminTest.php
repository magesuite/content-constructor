...
class CustomHtmlAdminTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \MageSuite\ContentConstructor\Components\CustomHtml\CustomHtmlAdmin
     */
    private $headline;
    ...
    public function setUp()
    {
        ...
        $this->headline = new \MageSuite\ContentConstructor\Components\CustomHtml\CustomHtmlAdmin(
            $this->templateMock,
            $this->locatorMock
        );
    }
